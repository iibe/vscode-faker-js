...
- Faker.js updated to [10.4.0](https://github.com/faker-js/faker/releases/tag/v10.4.0).

### Changed

- `DeepFlatten<T>` is impoved;

### Removed

- Deprecated Faker.js functions:
...
[X.Y.Z]: https://github.com/iibe/vscode-faker-js/compare/v9.6.0...HEAD
