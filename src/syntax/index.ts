 ...
 *
 * 1. The main `./src/syntax/index.ts` file imports and exports everything in `./src/syntax/**` in the correct order;
 * 1. Other modules in the project only import from `./src/syntax/index.ts`, and never directly from any of `./src/syntax/**` files.
